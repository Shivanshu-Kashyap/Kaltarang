...
const About = () => {
  return (
    <section className="relative w-full flex flex-col items-center text-center py-12 px-4 bg-grid bg-cover bg-center">
      ...
      {/* Welcome Text */}
      <p className="text-sm font-bitend uppercase tracking-widest text-gray-500 relative z-10">
        ─── WELCOME EXPLORER ───
      </p>

      {/* Description */}
      <h2 className="text-lg font-bitend md:text-xl font-light mt-2 max-w-3xl relative z-10">
      ...
      {/* Dummy Text */}
      <p className="mt-6 text-xs font-bitend md:text-sm max-w-4xl text-gray-600 leading-relaxed relative z-10">
